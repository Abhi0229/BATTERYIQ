...
export default function Services() {
  ...
  const services = [
    ...
    { icon: <Users className="w-7 h-7" />, title: 'ROI Calculator', desc: 'Input your fleet size, average cycles, and chemistry type. Get projected savings, ROI timeline, and comparison against industry benchmarks.', tag: 'Business', onClick: () => navigate('/roi-calculator') },
  ];
